 ...
 * Logger Utility Implementation for BigModuleC
 *
...
void Logger::info(const std::string& msg) {
    ...
    std::cout << "[" << currentTimestamp() << "] [BigModuleC] [INFO] " << msg << std::endl;
}

void Logger::warn(const std::string& msg) {
    std::lock_guard<std::mutex> lock(mutex_);
    std::cout << "[" << currentTimestamp() << "] [BigModuleC] [WARN] " << msg << std::endl;
}

void Logger::error(const std::string& msg) {
    std::lock_guard<std::mutex> lock(mutex_);
    std::cerr << "[" << currentTimestamp() << "] [BigModuleC] [ERROR] " << msg << std::endl;
}
